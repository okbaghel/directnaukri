...
export default function JobDetails() {
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      <h4 className="font-semibold text-blue-900 mb-2">Direct All Job HR Contact</h4>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-blue-200">
                      <h4 className="font-semibold text-blue-900 mb-2">Remove middleman</h4>
                      <p className="text-blue-700 text-sm">  Apply directly to HR without any agents. Our support team is available 24/7 to assist you.</p>
                    </div>
                  </div>
 ...
 एक बार भुगतान करें और एक महीने तक <strong> सभी नौकरियों के HR संपर्क  प्राप्त करें</strong>
</p>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black text-white rounded-lg shadow-xl">
                <div className="p-6">
                  <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-bold mb-2">One Time Payment, Get All Job HR Contacts</h3>
